...
__all__ = [
    "add_misdirection",
    "try_misdirection",
    "add_misdirection_scope",
    "in_misdirection_scope",
]
...
def add_misdirection(
    var: GameState, user: User, *, as_actor: bool = False, as_target: bool = False
):
...
def add_misdirection_scope(
    var: GameState, scope: Category | set[str], *, as_actor: bool = False, as_target: bool = False
):
    if as_actor:
...
def in_misdirection_scope(
    var: GameState,
    roles: Category | set[str] | str,
    *,
    as_actor: bool = False,
