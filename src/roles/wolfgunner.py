...
from src.roles.helper.wolves import is_known_wolf_ally, register_wolf
...
GUNNERS = setup_variables(
    "wolf gunner",
    hit=HIT_CHANCE,
    headshot=HEADSHOT_CHANCE,
    explode=EXPLODE_CHANCE,
    multiplier=SHOTS_MULTIPLIER,
)
