...
def on_player_win(
    ...
    if player in var.matchmaker_pairings or player in itertools.chain.from_iterable(
        var.matchmaker_pairings.values()
    ):
...
def on_chk_nightdone(evt: Event, var: GameState):
    mms = (
        get_all_players(var, ("matchmaker",)) - var.matchmaker_acted
    ) | var.matchmaker_acted_tonight
